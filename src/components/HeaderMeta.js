  ...
  render() {
    return (
      <div className="bg-gray-200">
        <div className="h-10 text-gray-600 text-xs tracking-wider uppercase w-10/12 mx-auto font-hairline hover:text-gray-800">
          <ul className="h-full flex justify-between items-center">
            <li>GXS DRY SCREW VACUUM PUMPS</li>
            <li>FREE DELIVERY FOR ALL ORDERS ABOVE 500,- EUR</li>
            <li>THE SCIENCE OF ADVANCED VACUUM</li>
            <li className="flex">
              <svg
              ...
              <p className="px-1"> +49 221 347 1112</p>
            </li>
            <li className="flex">
              <svg
                className="fill-current w-5 h-5"
              ...
              <p className="px-1"> SERVICE@NOWVAC.COM</p>
            </li>
          </ul>
        </div>
      </div>
