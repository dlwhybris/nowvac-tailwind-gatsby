...
export default connectSearchBox(({refine, ...rest}) => (
    <div className="w-full flex items-center">
        <Dropdown
            ...
            options={data}
        />
        <input type="text" onChange={e => refine(e.target.value)}
               {...rest}
        ...
        />
        <button
            className="h-8 focus:outline-none bg-java-500 w-40 uppercase text-sm rounded-r-lg text-white font-light hover:bg-peach-500 tracking-wider">
